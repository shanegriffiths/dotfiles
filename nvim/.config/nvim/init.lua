...
require('lazy').setup({
  ...
  -- Tailwind CSS colour swatches and class autocomplete
  { 'luckasRanarison/tailwind-tools.nvim', name = 'tailwind-tools', opts = { server = { override = false } } },
  ...
  -- Yazi file manager integration
  {
    ...
    keys = {
      ...
      { '<leader>E', '<cmd>Yazi cwd<cr>', desc = 'Open Yazi (working directory)' },
    },
    opts = {},
  },
